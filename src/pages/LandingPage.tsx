                    ...
                    <div className="grid lg:grid-cols-2 gap-16 items-start">
                        ...
                        <div className="space-y-6">
                            ...
                            <div className="bg-white p-8 rounded-3xl border border-[#E8E3D8] hover:border-[#E6B17E]/50 transition-all
                                ...
                                <div className="flex items-start gap-6">
                                    <div className="flex-shrink-0">
                                        <div className="w-16 h-16 rounded-2xl bg-gradient-to-br from-[#8B0000]/10 to-[#8B0000]/5 flex items-center
                                                        justify-center">

                                            <Heart className="text-2xl text-[#8B0000]" />
                                        </div>
                                    </div>
                            ...
                            <div className="bg-white p-6 rounded-2xl border border-[#E6B17E]/20 shadow-lg">
                                <div className="flex flex-col sm:flex-row items-center justify-between gap-6">
                                    ...
                                    <div className="flex items-center gap-8">
                                        ...
                                        <div className="w-px h-8 bg-[#E8E3D8] hidden md:block"></div>

                                        <div className="text-center group">

                                            <div className="text-2xl font-bold text-[#0F0F0F] mb-1">50+</div>
                                            <div className="text-xs text-[#0F0F0F]/70">Expert Team</div>
